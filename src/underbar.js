(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var unfiltered = [];
    _.filter(collection, function(param) {
      if(!test(param)) {
        unfiltered.push(param);
      }
    });
    return unfiltered;
  };
  ...
  _.defaults = function(obj) {
    ...
    _.each(properties, function(value){
      // iterate though keys w/in value
      _.each(value, function(innerValue, key){
        //if undefined
        if(!obj.hasOwnProperty(key)) {
          obj[key] = innerValue;
        }
            //add key/value pair to original object
      });
    });
    return obj;
  };
  ...
  _.shuffle = function(array) {
    ...
    _.each(shuffled, function(value))
